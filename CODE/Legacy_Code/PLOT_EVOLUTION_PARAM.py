...
f,axes=plt.subplots(nrows=2,ncols=1,sharex=True,sharey=True,gridspec_kw={'height_ratios':[1,1]},figsize=(8,10))
axes[0].errorbar(LFfittingparams[0:5,0],LFfittingparams[0:5,6]/1000.,yerr=LFfittingparams[0:5,7]/1000.,color='black',label='This Work')
...
lcbgphistaru=unp.uarray([LCBGfittingparams[0:5,5],LCBGfittingparams[0:5,7]])
...
lcbgalpha=LCBGfittingparams[0:5,2
...
lcbgju=lcbgphistaru/1000*np.power(10,(lcbgmstaru-5.48)/-2.5)*sp.special.gammainc(lcbgalpha+2,np.power(10,(lcbgmstar+18.5)/2.5))
galju=allphistaru/1000*np.power(10,(allmstaru-5.48)/-2.5)*sp.special.gammainc(2+allalpha,np.power(10,(allmstar+18.5)/2.5))
